...
const experience_letter_service_1 = require("./experience-letter.service");
exports.releaseLetterController = {
    getOfferLetterAll: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield experience_letter_service_1.experienceLetterService.getExperienceLetterAll(req.query);
    ...
    createBulkOfferLetter(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield experience_letter_service_1.experienceLetterService.createBulkExperienceLetters(filteredRows, req.user);
            (0, sendResponse_1.default)(res, {
                statusCode: http_status_codes_1.StatusCodes.OK,
                success: true,
